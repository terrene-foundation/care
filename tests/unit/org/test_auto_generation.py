...
class TestRoleCatalog:
    ...
    def test_catalog_has_builtin_roles(self):
        ...
        from care_platform.build.org.role_catalog import RoleCatalog
...
class TestOrgGeneratorConfig:
    ...
    def test_org_generator_config_creation(self):
        ...
        from care_platform.build.org.generator import (
            DepartmentSpec,
            OrgGeneratorConfig,
            TeamSpec,
        )
    ...
    def test_team_spec_with_roles(self):
        ...
        from care_platform.build.org.generator import TeamSpec
    ...
    def test_department_spec_with_teams(self):
        ...
        from care_platform.build.org.generator import DepartmentSpec, TeamSpec
...
class TestOrgGenerator:
    ...
    def test_generate_returns_org_definition(self):
        ...
        from care_platform.build.org.generator import OrgGenerator
...
class TestOrgGeneratorEdgeCases:
    ...
    def test_empty_departments_raises(self):
        ...
        from care_platform.build.org.generator import OrgGeneratorConfig
...
class TestOrgGenerateCLI:
    ...
    def test_org_generate_command_exists(self):
        ...
        from care_platform.build.cli import org
