...
if TYPE_CHECKING:
    ...
    from care_platform.persistence.health import TrustStoreHealthCheck
    from care_platform.persistence.store import TrustStore
    from care_platform.trust.authorization import AuthorizationCheck
...
class ApprovalRequest(BaseModel):
    ...
    .. deprecated::
        Use care_platform.execution.approval.PendingAction with a shared
