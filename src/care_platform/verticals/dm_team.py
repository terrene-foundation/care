...
workspaces/care-platform/01-analysis/01-research/03-eatp-trust-model-dm-team.md
...
def get_dm_team_config() -> dict:
    """Get the complete DM team configuration as a dict suitable for PlatformConfig.
