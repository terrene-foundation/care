...
class Bridge(BaseModel):
    ...
    sharing_policy: object | None = Field(
        ...
        description=(
            ...
            "care_platform.constraint.bridge_envelope.BridgeSharingPolicy."
        ),
    )
...
class BridgeManager:
    ...
    def __init__(
        ...
        from care_platform.workspace.bridge_lifecycle import BridgeStateMachine
        ...
        *,
        ...
        with self._lock:
            ...
            if bridge.sharing_policy is not None:
                from care_platform.constraint.bridge_envelope import SharingMode
