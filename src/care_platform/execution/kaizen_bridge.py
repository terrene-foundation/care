...
from care_platform.execution.llm_backend import BackendRouter, LLMRequest
from care_platform.execution.runtime import ExecutionRuntime, Task, TaskResult
    ...
    def execute_task(self, task: Task) -> TaskResult:
        ...
        try:
            ...
            if is_cross_team and active_bridge is not None and self._eatp_bridge is not None:
                try:
                    from care_platform.audit.bridge_audit import create_bridge_audit_pair
