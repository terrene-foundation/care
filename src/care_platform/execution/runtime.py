...
from care_platform.trust.posture import NEVER_DELEGATED_ACTIONS

if TYPE_CHECKING:
    from care_platform.config.schema import VerificationGradientConfig
...
class ExecutionRuntime:
    ...
    def process_next(self) -> Task | None:
        ...
        if self._constraint_enforcer is not None:
            ...
            from care_platform.constraint.middleware import ActionOutcome
    ...
    def _check_bridge_verification(
        ...
        from care_platform.trust.bridge_posture import (
