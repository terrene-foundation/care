...
from pact.trust.constraint.circuit_breaker import CircuitBreaker, CircuitBreakerOpen
...
if TYPE_CHECKING:
    from pact.trust.authorization import AuthorizationCheck
    from pact.trust.constraint.signing import SignedEnvelope
    from pact.trust.eatp_bridge import EATPBridge
    from pact.trust.store.health import TrustStoreHealthCheck
