...
import pact
from pact.build.config.env import EnvConfig, load_env_config
...
from pact.use.api.events import event_bus
...
def create_app(
    ...
    def _get_firebase_verify():  # noqa: ANN202
        ...
        if _firebase_verify is None:
            try:
                from pact.trust.auth.firebase_admin import verify_firebase_id_token
