...
Other domain applications of CO:

- CO for Education (COE) — university GenAI assessment (in analysis, pilot planned)
- CO for Governance (COG) — standards development, constitutional design (in production, self-hosting)
- CO for Compliance (COComp) — regulatory operations (sketch complete)
- CO for Finance (COF) — finance education and analysis (in production)
- CO for Operations — enterprise workflows (future)
