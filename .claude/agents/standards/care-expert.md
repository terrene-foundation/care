...
- **coe-expert** - For how CARE's Mirror Thesis applies to university assessment (COE)
- **cog-expert** - For how the Foundation uses CARE/CO to govern its own work (COG)
...
Claude Code is an Execution Plane tool with execution-layer access controls. It is NOT a governance framework. The Foundation's CARE provides the governance layer that sits above execution tools.
