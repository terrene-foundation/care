...
| Agents    | `tdd-implementer`, `testing-specialist`, `value-auditor`, `build-fix`, `framework-advisor`           | `constitution-expert`, `governance-layer-expert`, `publication-expert`, `pact-architect`                               |
