---
name: co-reference
description: Load CO (Cognitive Orchestration) methodology reference. Use when discussing the domain-agnostic base methodology for human-AI collaboration, the eight first principles, the five-layer architecture, or the relationship between CO and domain applications like COC, COR, COE, COG, COF.
allowed-tools:
  - Read
  - Glob
  - Grep
...
8. **Authentic Voice** — Output reflects human direction; disclose AI; mitigate detection bias
...
| CO for Research   | COR        | In production         |
| CO for Education  | COE        | In analysis           |
| CO for Governance | COG        | In production         |
| CO for Finance    | COF        | In production         |
