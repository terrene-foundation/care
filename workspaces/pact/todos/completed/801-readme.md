...
Create the README for the PACT repository. This is the first thing developers, evaluators, and potential contributors see. Must clearly explain what the platform is, how it differs from generic agent orchestrators, and how to get started.
...
- README clearly distinguishes PACT from generic orchestrators
