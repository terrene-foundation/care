...
- [ ] Document all public classes and methods:
  - `pact.config` — Configuration models and loaders
  - `pact.constraint` — Constraint envelopes, verification gradient
  - `pact.trust` — Trust postures, attestation, scoring, delegation
  - `pact.audit` — Audit anchors and chains
  - `pact.workspace` — Workspace management
  - `pact.execution` — Agent execution runtime
