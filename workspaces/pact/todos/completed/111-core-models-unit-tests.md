...
- [x] Test suite for `pact/config/` (schema, loader, agent definitions)
- [x] Test suite for `pact/constraint/` (envelope, gradient, dimensions)
- [x] Test suite for `pact/trust/` (posture, attestation, scoring)
- [x] Test suite for `pact/audit/` (anchor, chain)
- [x] Test suite for `pact/workspace/` (model, lifecycle, registry)
