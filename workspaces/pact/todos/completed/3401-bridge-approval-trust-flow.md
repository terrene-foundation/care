...
- `src/pact/workspace/bridge.py` (extend `_activate`, `suspend_bridge`, `close`, and `revoke` methods)
- `src/pact/trust/bridge_trust.py` (extend with `establish_bridge_trust` and `invalidate_bridge_delegations`)
