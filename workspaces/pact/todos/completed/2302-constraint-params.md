...
- `src/pact/config/schema.py` — constraint model field declarations for all three dimensions
- `src/pact/constraint/envelope.py` — evaluation logic for daily/monthly spend accumulators, vendor checks, recipient limits, escalation trigger matching, duration enforcement
