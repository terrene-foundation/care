...
**Verified by**: VersionTracker + EnvelopeVersion + EnvelopeDiff in `pact/persistence/versioning.py`; 24 unit tests pass in `tests/unit/persistence/test_versioning.py`
