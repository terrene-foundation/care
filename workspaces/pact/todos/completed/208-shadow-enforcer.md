...
`ShadowEnforcer` implemented in `pact/trust/shadow_enforcer.py` with metrics collection and posture transition reporting.

- `pact/trust/shadow_enforcer.py` — `ShadowEnforcer`, `ShadowResult`, `ShadowMetrics`
...
- [x] `pact/trust/shadow_enforcer.py` with `ShadowEnforcer`
