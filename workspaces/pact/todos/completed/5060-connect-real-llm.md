...
- `src/pact/verticals/dm_runner.py` — switch from StubBackend to real backend for content creator
- `src/pact/execution/backends/` — verify Anthropic/OpenAI backends work with DM prompts
