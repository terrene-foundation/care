...
`ReasoningTrace` and `ReasoningTraceStore` implemented in `pact/trust/reasoning.py`.

- `pact/trust/reasoning.py` — `ReasoningTrace`, `ReasoningTraceStore`, `ConfidentialityLevel`
...
- [x] `pact/trust/reasoning.py` with `ReasoningTrace` model
