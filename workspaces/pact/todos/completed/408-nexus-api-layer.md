...
Deploy the PACT as a Nexus multi-channel application, exposing REST API, CLI, and MCP interfaces. Consult the nexus-specialist before implementing — Nexus handles the deployment topology; the task is defining what endpoints the PACT needs. This enables multiple humans and external integrations to interact with the platform concurrently.

## Tasks

- [ ] Consult nexus-specialist to design API topology for PACT
...
- [ ] Implement MCP integration:
  - PACT as an MCP server (agents can query it)
