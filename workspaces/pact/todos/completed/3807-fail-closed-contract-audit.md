...
- `src/pact/trust/**/*.py`
- `src/pact/constraint/**/*.py`
- `src/pact/audit/**/*.py`
- `src/pact/persistence/**/*.py`
...
- Scans `src/pact/trust/` and `src/pact/constraint/` directories
...
- **Audit report**: `workspaces/pact/04-validate/fail-closed-audit.md`
- **Fixes**: Various files under `src/pact/trust/` and `src/pact/constraint/`
