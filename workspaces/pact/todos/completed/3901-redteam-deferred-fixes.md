...
- File: `src/pact/trust/eatp_bridge.py`
...
- Files: `src/pact/constraint/gradient.py`, `src/pact/constraint/enforcement.py`
...
- File: `src/pact/trust/shadow_enforcer.py`
...
- File: `src/pact/persistence/posture_history.py`
