...
Create a security policy and responsible disclosure process. As an open-source platform handling cryptographic trust chains, the PACT has a heightened responsibility for security transparency. Vulnerabilities in constraint enforcement or audit chain integrity have direct trust implications.
