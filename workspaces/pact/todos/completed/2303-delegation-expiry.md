...
- `src/pact/constraint/middleware.py` — add expiry check in the delegation resolution step of the verification pipeline
- `src/pact/trust/delegation.py` — expose a helper or property that reports whether a delegation record is currently valid (not expired and not revoked)
