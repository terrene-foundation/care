...
`VerificationMiddleware` implemented in `pact/constraint/middleware.py` with all four gradient routing outcomes.

- `pact/constraint/middleware.py` — `VerificationMiddleware`, `ActionOutcome`, `MiddlewareResult`
...
- [x] `pact/constraint/middleware.py` — `VerificationMiddleware`
