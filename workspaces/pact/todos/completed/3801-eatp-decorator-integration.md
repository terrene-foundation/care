...
- **New**: `src/pact/trust/decorators.py` (303 lines)
- **Modified**: `src/pact/trust/__init__.py` (4 new exports: `CareTrustOpsProvider`, `care_verified`, `care_audited`, `care_shadow`)
