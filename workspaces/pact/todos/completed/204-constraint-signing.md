...
`SignedEnvelope` and `EnvelopeVersionHistory` implemented in `pact/constraint/signing.py`.

- `pact/constraint/signing.py` — Ed25519 signing, tamper detection, version history, 90-day expiry
