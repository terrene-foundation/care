...
- `src/pact/api/server.py` — WebSocket endpoint handler (connection upgrade check)
- `src/pact/api/events.py` — event delivery logic (if authentication state needs to be threaded through)
