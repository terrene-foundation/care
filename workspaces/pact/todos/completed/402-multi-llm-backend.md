...
**Verified by**: LLMBackend ABC + LLMProvider enum + LLMRequest + LLMResponse + StubBackend + BackendRouter in `pact/execution/llm_backend.py`; 20 unit tests pass in `tests/unit/execution/test_llm_backend.py`
