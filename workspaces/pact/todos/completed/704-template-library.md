...
- [ ] Create `pact/templates/` directory:
  - `pact/templates/teams/` — team-level constraint templates
  - `pact/templates/agents/` — agent role-level constraint templates
  - `pact/templates/orgs/` — complete org structure templates
