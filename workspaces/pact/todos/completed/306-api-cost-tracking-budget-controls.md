...
**Verified by**: CostTracker + ApiCostRecord + BudgetAlert + CostReport in `pact/persistence/cost_tracking.py`; 41 unit tests pass in `tests/unit/persistence/test_cost_tracking.py`
...
- [ ] Implement CLI commands:
  - `pact cost report --team dm --days 30` — cost report
  - `pact cost set-budget --agent content-creator --daily 2.00` — set budget
