...
**Verified by**: Bridge + BridgeManager + BridgePermission + standing bridge establishment + dual-side approval in `pact/workspace/bridge.py`; 26 unit tests pass in `tests/unit/workspace/test_bridge.py`
...
- [ ] Implement `pact/workspace/bridge.py`:
