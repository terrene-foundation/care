...
- All files containing gap adapters: `src/pact/trust/messaging.py`, `src/pact/trust/revocation.py`, `src/pact/trust/posture.py` — verify `# EATP-GAP` markers are present and correctly formatted
- `workspaces/pact/01-analysis/01-research/04-eatp-sdk-gaps.md` — update gap status, add file/line references, add "Gap Closure Requirements" section
