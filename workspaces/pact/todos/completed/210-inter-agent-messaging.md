...
`AgentMessage`, `MessageChannel`, and `MessageRouter` implemented in `pact/trust/messaging.py`.

- `pact/trust/messaging.py` — full message passing with nonce-based replay protection
...
- [x] `pact/trust/messaging.py` with `AgentMessage` model
