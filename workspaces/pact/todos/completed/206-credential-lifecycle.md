...
`VerificationToken` and `CredentialManager` implemented in `pact/trust/credentials.py`.

- `pact/trust/credentials.py` — 5-minute TTL tokens, bulk revocation, token registry
