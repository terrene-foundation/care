...
- [x] Agent definition complete and valid — `DM_TEAM_LEAD` in `pact/verticals/dm_team.py`
...
- `pact/verticals/dm_team.py` — DM_TEAM_LEAD, DM_LEAD_ENVELOPE, validate_dm_team()
