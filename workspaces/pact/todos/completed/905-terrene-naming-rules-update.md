# 905: Update Terrene Naming Rules — PACT Terminology
...
Update `.claude/rules/terrene-naming.md` to include PACT terminology. Currently, the naming rules cover the Trinity (CARE, EATP, CO), COC, and licensing — but do not cover PACT-specific terms: constraint envelopes, verification gradient, trust postures, workspace-as-knowledge-base, cross-functional bridges.

## Tasks

- [ ] Read current state of `.claude/rules/terrene-naming.md`
- [ ] Add PACT terminology section:
  - Platform layer: "PACT" (Apache 2.0) — governed operational model
  - "CARE specification" vs "PACT" — disambiguation rule
...
- All PACT terms defined with canonical names
- Disambiguation between "CARE specification" and "PACT" explicit
