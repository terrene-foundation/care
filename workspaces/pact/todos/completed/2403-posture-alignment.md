...
- `src/pact/trust/posture.py` — use `eatp.postures.PostureStateMachine` as the base; register `PostureEvidence` checks as `TransitionGuards`; preserve `NEVER_DELEGATED_ACTIONS`; add 4 gap adapters with `# EATP-GAP` markers
