...
- `src/pact/api/server.py` — `get_app()` function (server entry point)
- `src/pact/cli/__init__.py` — `main()` function (CLI entry point)
- `src/pact/bootstrap.py` — module top-level or `bootstrap()` function (initialization entry point)
