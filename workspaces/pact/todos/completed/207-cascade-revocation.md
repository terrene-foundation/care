...
`RevocationManager` implemented in `pact/trust/revocation.py` with surgical and cascade revocation.

- `pact/trust/revocation.py` — `RevocationManager`, `RevocationRecord`, `RevocationRegistry`
