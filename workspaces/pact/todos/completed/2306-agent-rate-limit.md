...
- `src/pact/constraint/middleware.py` — add per-agent rate limit counters with rolling window and lock; evaluate against `max_requests_per_minute` from the operational constraint dimension
