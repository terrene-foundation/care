...
**Verified by**: ScopedBridge with valid_until + one_time_use + auto-expiry in `pact/workspace/bridge.py`; tests for scoped bridge lifecycle, expiry, and one-time-use in `tests/unit/workspace/test_bridge.py`
