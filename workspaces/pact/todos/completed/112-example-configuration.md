...
Create an example PACT configuration that models the Terrene Foundation itself — teams, agents, constraint envelopes, workspaces. This serves as both documentation and the actual configuration the Foundation will use.
