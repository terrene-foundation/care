...
**Verified by**: AdHocBridge with request_payload + respond_to_adhoc + auto-close on response in `pact/workspace/bridge.py`; tests for ad-hoc create, respond, and auto-close in `tests/unit/workspace/test_bridge.py`
