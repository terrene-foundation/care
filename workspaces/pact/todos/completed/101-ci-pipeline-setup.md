...
Configure the CI pipeline for the `pact` repository. The project uses pytest, and the existing `scripts/ci/run-all.js` needs adaptation for the PACT.
...
- [ ] Create test fixtures directory structure matching `pact/` modules
