...
- Modify: `src/pact/trust/attestation.py` (add `has_authorization()`)
- New: `src/pact/trust/authorization.py` (AuthorizationCheck)
- Modify: `src/pact/constraint/middleware.py`
