...
- Modify: `src/pact/constraint/signing.py`
- New utility: `src/pact/trust/jcs.py` (canonical_hash wrapper used by ALL modules)
- Modify: `src/pact/audit/anchor.py` (hash computation)
- Modify: `src/pact/trust/attestation.py` (content_hash → canonical_hash)
- Modify: `src/pact/trust/reasoning.py` (compute_hash → canonical_hash)
- Modify: `src/pact/constraint/envelope.py` (content_hash → canonical_hash)
