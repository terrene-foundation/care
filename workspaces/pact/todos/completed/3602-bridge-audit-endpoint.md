...
Wire into `PlatformAPI.bridge_audit()` in `src/pact/api/endpoints.py` and register the route in `src/pact/api/server.py`.

## Where

- `src/pact/api/endpoints.py` (add `bridge_audit()` method)
- `src/pact/api/server.py` (register route)
