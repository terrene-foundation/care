...
Phase 3 identified 14 gaps in the EATP SDK that PACT currently works around. These should be addressed in the EATP SDK, not reimplemented in the platform. See `workspaces/pact/01-analysis/01-research/04-eatp-sdk-gaps.md` for the full list.
