...
**S9 (EATP Decorators) is the highest-priority gap.** The EATP spec defines VERIFY, AUDIT, and shadow as core operations. Every other spec operation has a programmatic interface in the PACT — but these three lack the natural decorator expression. This is the difference between:
