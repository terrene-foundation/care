...
Before ANY code flows from Aegis to the PACT:
...
1. **S1 (Behavioral Scoring)**: Write the scoring algorithm section of the CARE spec first. Derive factor weights independently. The PACT implementation follows the spec.
...
**ALL 12 strengths: UPSTREAM to PACT (Apache 2.0).**
