# Architecture Gap Analysis: COC Setup → PACT
...
## Five Gaps Between COC Setup and PACT
...
Documents that would need updating if the PACT layer is formalized:
...
| `docs/00-anchor/03-ip-ownership.md` | Clarify IP ownership for PACT |
