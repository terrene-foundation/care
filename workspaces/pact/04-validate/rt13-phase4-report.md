...
| File                                              | Changes                                                                          |
| ------------------------------------------------- | -------------------------------------------------------------------------------- |
| `src/pact/workspace/bridge.py`           | Self-bridge prevention, bridge count limit, access log cap, ID length validation |
| `src/pact/api/endpoints.py`              | Self-bridge + length validation at API, payload redaction                        |
| `src/pact/execution/kaizen_bridge.py`    | Use `is_active` instead of status check                                          |
| `src/pact/execution/runtime.py`          | Use `is_active` instead of status check                                          |
| `src/pact/trust/delegation.py`           | Handle `financial=None` in `validate_tightening`                                 |
| `src/pact/execution/posture_enforcer.py` | Extended homoglyph map with Greek characters                                     |
