...
Add `care-platform org status` command showing runtime org health: active agents, pending approvals, trust chain validity, last verification time, constraint envelope coverage.

## Where

- `src/care_platform/cli/__init__.py` — add `org status` command
